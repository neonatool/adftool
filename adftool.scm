...
(define-public adftool
  (package
   ...
   (inputs
    (list gnu-gettext hdf5 zlib gmp python))
   (native-inputs
    (list autoconf autoconf-archive
	  ;; Automake 1.16.3 does not let me change the python prefix.
	  automake-1.16.5
	  libtool
	  valgrind
